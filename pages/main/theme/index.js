...
const theme = () => {
    ...
    const setText = useUserDataStore(state => state.setText)


    return(
        <Layout>
          <div className="theme-container">
                 <h3 className="theme-text">Primary</h3>
             <div className="theme-box">
                 {Color.map(x => (
                     <Theme key={x} color={x} setColor={setPrimary} />
                 ))}
             </div> 
                 <h3 className="theme-text">Secondary</h3>
             <div className="theme-box">
             {Color.map(x => (
                     <Theme key={x} color={x} setColor={setSecondary} />
                 ))}
             </div> 
                 <h3 className="theme-text">Font</h3>
             <div className="theme-box">
             {Color.map(x => (
                     <Theme key={x} color={x} setColor={setText} />
                 ))}
             </div> 
          </div>   
        </Layout>
